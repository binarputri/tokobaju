            ...
            <tr>
              <td align="left" valign="top" class="Teks_Testimonial" scope="col">
                ...
                <div><a href="isitestimonial.php"></a><br />
                  <a href="data_testimonial.php" target="_self"></a></div>
                <br /></td>
            </tr>
          </table></td>
        </tr>
  ...
  <td width="400" align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Area_Informasi">
    ...
    <tr>
      <th colspan="2" align="left" valign="top"><strong>Pesanan akan kami cancel apabila dalam 2x24 jam belum kami terima pembayarannya.</strong><br />
        ...
        <br />
        <strong>Nama Pemilik Rekening: <span class="Teks_Transaksi">Toko Baju</span></strong><br />
        <br />
        <strong>BCA</strong><br />
        Norek: <span class="Teks_Bank">896543456786</span><br />
        Cabang: Jember<br />
        <br />

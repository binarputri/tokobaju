...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 27, 2015 at 02:14 PM
...
--
-- Indexes for table `_baju`
--
ALTER TABLE `_baju`
 ADD PRIMARY KEY (`id_baju`);

--
-- Indexes for table `_baju_kategori`
--
ALTER TABLE `_baju_kategori`
 ADD PRIMARY KEY (`id_baju_kategori`);

--
-- Indexes for table `_baju_merk`
--
ALTER TABLE `_baju_merk`
 ADD PRIMARY KEY (`id_baju_merk`);
...
--
-- Indexes for table `_pemesanan`
--
ALTER TABLE `_pemesanan`

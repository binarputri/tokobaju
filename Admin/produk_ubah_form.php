...
<form id="form1" name="form1" method="post" action="produk_ubah_proses.php" enctype="multipart/form-data">
  <table width="400" border="0" align="left">
    ...
    <tr>
      ...
      <td align="left" valign="top"><label for="foto"></label>
        <input type="file" name="foto" id="foto" value="<?php echo $data['gambar'] ?>" /></td>
    </tr>
    <tr>
      <td align="left" valign="top">&nbsp;</td>
      <td align="left" valign="top">&nbsp;</td>
